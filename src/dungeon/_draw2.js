...
const pxBorder     = 1;
const pxGridLine   = 0.1;

const colorGridFill     = '#121212';
const colorGridStroke   = '#333333';
const colorLockedFill   = '#cccccc';
const colorPillarFill   = '#f9f9f9';
const colorHoleFill   = '#101010';
const colorPillarStroke = '#505050'//'rgba(207, 207, 207, 0.7)';
const colorRoomFill     = '#f0f0d0'//'rgba(255, 255, 200, 0.7)';
const colorRoomStroke   = '#FFFFee';
const colorTransparent  = '#c0c080'//'transparent';
const colorTrapFill     = '#ff3333'//'rgba(207, 207, 207, 0.8)';

const pillarRadiusRatio = 0.18; // % of pxCell
const holeRadiusRatio   = 0.2//0.25; // % of pxCell

const doorInset    = 8//12; // In px?
const doorWidth    = 4//8; // TODO rename to door size

const doorSecretLabel    = 'S';
const doorConcealedLabel = 'C'; // Caché
...
export function drawDoor(door) {
    ...
    if (lockable.has(type)) {
        ...
        details.push(drawCircle({ cx, cy, r: Math.round(pxCell * holeRadiusRatio) }, { fill: colorHoleFill }));
    } else if (type === 'secret') {
