...
//const complexityMultiplierMinXY     = 6;
...
function generateDungeonRooms(config) {
    ...
    let count = dungeonComplexity*roomMultiplier
    //console.log(count)
    ...
    let rooms = generateRooms({
        ...
        rooms: {
            ...config.rooms,
            roomCount: count,// getMaxRoomCount(dungeonComplexity),
        },
    });
 ...
 * @returns {Dimensions}
 */
function generateMapDimensions(complexity, dimention) {
    //let dimensionMin = complexity * complexityMultiplierMinXY;
    //let dimensionMax = complexity * complexityMultiplierMaxXY;

    let width  = complexity * dimention//roll(dimensionMin, dimensionMax);
    let height = complexity * dimention//roll(dimensionMin, dimensionMax);

    //console.log( width*2, height*2)// meter
    //console.log( width*16, height*16)// pixel
...
function generateTraps(count) {
    ...
    let trapCount = trapCountMultiplier//roll(min, max);
...
export function generateDungeon(config) {
    ...
    let gridDimensions  = generateMapDimensions(dungeonComplexity, dimentionMultiplier);
