import { Ps as Vector2, lo as RenderTarget } from "./three.core-BlZEhazR.js";
import { NodeMaterial, NodeUpdateType, QuadMesh, RendererUtils, TempNode } from "./three_webgpu.js";
import { Fn, convertToTexture, float, passTexture, premultiplyAlpha, uniform, unpremultiplyAlpha, uv, vec2, vec4 } from "./three_tsl.js";
//#region node_modules/three/examples/jsm/tsl/display/GaussianBlurNode.js
...
*/
var gaussianBlur = (node, directionNode, sigma, options = {}) => new GaussianBlurNode(convertToTexture(node), directionNode, sigma, options);
/**
...
//#endregion
export { GaussianBlurNode as default, gaussianBlur, premultipliedGaussianBlur };
